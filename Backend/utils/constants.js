...
// Geographic Rules
// DEPRECATED: Radius-based vendor rules are being removed. 
// These constants are kept for backward compatibility during transition but will no longer enforce restrictions.
const VENDOR_COVERAGE_RADIUS_KM = 0; // Effectively disabled
const VENDOR_ASSIGNMENT_BUFFER_KM = 0;
const VENDOR_ASSIGNMENT_MAX_RADIUS_KM = 0;
// 0.8km total
