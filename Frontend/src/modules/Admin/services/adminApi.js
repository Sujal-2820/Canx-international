 ...
 * - Production: https://api.canxinternational.com/api
 */
...
/**
 * Get Vendor Rankings
 * GET /admin/vendors/rankings
 */
export async function getVendorRankings(params) {
  const queryString = new URLSearchParams(params).toString()
  return apiRequest(`/admin/vendors/rankings?${queryString}`)
}
...
/**
 * Delete Vendor Purchase Invoice
 * DELETE /admin/vendors/purchases/:requestId
 * 
 * @param {string} requestId - Purchase request ID
 * @returns {Promise<Object>} - { message: string, id: string }
 */
export async function deleteVendorPurchase(requestId) {
  return apiRequest(`/admin/vendors/purchases/${requestId}`, {
    method: 'DELETE',
  })
}
