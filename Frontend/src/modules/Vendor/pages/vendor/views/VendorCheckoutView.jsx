...
export function VendorCheckoutView({ onBack, onOrderPlaced }) {
    ...
    const isFormValid = useMemo(() => {
        ...
        return true
    }, [cart, reason, bankDetails, policyAccepted, confirmationText, paymentMode, creditInfo, totals.baseTotal])
            ...
            <section className="space-y-4">
                ...
                <div className="p-4 rounded-2xl border border-gray-100 bg-white shadow-sm">
                    ...
                    <p className={cn(
                        ...
                        reason.trim().length >= 10 ? "text-green-600" : "text-gray-400"
                    )}>
                            ...
                            <input
                                ...
                                className={cn(
                                    ...
                                    confirmationText.trim().toLowerCase() === 'confirm'
                                        ? "border-green-200 focus:ring-green-500 focus:border-green-500 bg-green-50"
                                        : "border-gray-200 focus:ring-blue-500 focus:border-blue-500"
                                )}
                            />
                        </div>
