...
export function VendorProfileView({ onNavigate, onLogout }) {
    ...
    const { fetchProfile, updateVendorProfile } = useVendorApi()
        ...
        <div className="user-account-view space-y-6">
            ...
            <div className="user-account-view__header">
                ...
                <div className="user-account-view__header-info">
                    <h2 className="user-account-view__header-name"><TransText>{profile?.name || 'Vendor Partner'}</TransText></h2>
                ...
                <div className="user-account-view__panel" onClick={() => setShowSupportPanel(false)}>
                    <div className="user-account-view__panel-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="user-account-view__panel-body p-6 space-y-4">
                            ...
                            <div className="p-4 rounded-xl bg-blue-50 border border-blue-100">
                                <h4 className="font-bold text-blue-900 mb-1"><Trans>Vendor Documentation</Trans></h4>
                                <p className="text-sm text-blue-700 mb-3"><Trans>Learn how to manage inventory, track orders, and handle repayments.</Trans></p>
